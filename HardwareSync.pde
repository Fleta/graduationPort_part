...
PrintWriter recordoutput;
PrintWriter detectoutput;
...
void stopButtonWasPressed() {
  ...
  if (isRunning) {
    ...
    Thread makeFileThread = new Thread(new makeFileThread());
    makeFileThread.start();
  }
}

void recordButtonWasPressed(){
  ...
  try{
    ...
    if(isRecording){
      ...
      topNav.recordButton.setColorNotPressed(color(224, 56, 45));
      String fname = "";
      fname = "OpenBCI-RAW-";
      ...
      fname = fname + ".txt";
      recordoutput = new PrintWriter("C:\\Users\\Lagami-Desktop\\Documents\\OpenBCI_GUI-master\\OpenBCI_GUI\\SavedData\\action" + record_action + "\\" +fname); //change here
      recordoutput.print(record_action-1);
      TimerTask m_task= new TimerTask(){
        @Override
        public void run(){
          recordButtonWasPressed();
        }
      };
      mtimer.schedule(m_task, 2000);
...
void stopRecording(){
  println("void stopRecording 258");
  topNav.recordButton.setColorNotPressed(color(184, 220, 105));
}
...
void actionWasPressed(){
  switch(record_action){
    case 1:
      println("1");
      topNav.action5.setColorNotPressed(color(184, 220, 105));
      topNav.action4.setColorNotPressed(color(184, 220, 105));
      topNav.action3.setColorNotPressed(color(184, 220, 105));
      topNav.action2.setColorNotPressed(color(184, 220, 105));
      topNav.action1.setColorNotPressed(color(224, 56, 45));
      break;
    case 2:
      println("2");
      topNav.action5.setColorNotPressed(color(184, 220, 105));
      topNav.action4.setColorNotPressed(color(184, 220, 105));
      topNav.action3.setColorNotPressed(color(184, 220, 105));
      topNav.action1.setColorNotPressed(color(184, 220, 105));
      topNav.action2.setColorNotPressed(color(224, 56, 45));
      break;
    case 3:
      println("3");
      topNav.action5.setColorNotPressed(color(184, 220, 105));
      ...
      topNav.action1.setColorNotPressed(color(184, 220, 105));
      topNav.action2.setColorNotPressed(color(184, 220, 105));
      topNav.action3.setColorNotPressed(color(224, 56, 45));
      break;
    case 4:
      println("4");
      topNav.action5.setColorNotPressed(color(184, 220, 105));
      ...
      topNav.action3.setColorNotPressed(color(184, 220, 105));
      topNav.action2.setColorNotPressed(color(184, 220, 105));
      topNav.action4.setColorNotPressed(color(224, 56, 45));
      break;
    case 5:
      println("5");
      topNav.action5.setColorNotPressed(color(224, 56, 45));
      topNav.action4.setColorNotPressed(color(184, 220, 105));
      topNav.action3.setColorNotPressed(color(184, 220, 105));
      topNav.action2.setColorNotPressed(color(184, 220, 105));
      topNav.action1.setColorNotPressed(color(184, 220, 105));
