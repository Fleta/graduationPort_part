...
OutputFile_rawtxt fileoutput_record; //record output file
String output_fname; 
String fileName = "N/A";
...
boolean isRecording = false; //isrecording
int record_action = 0;
int fileflag = 1;
...
void initSystem() {
  ...
  for (int Ichan=0; Ichan < nchan; Ichan++) {
    ...
    fftBuff[Ichan] = new FFT(Nfft, get_fs_Hz_safe()); //bookmark4
...
void systemDraw() { //for drawing to the screen //Setting title! bookmark1
